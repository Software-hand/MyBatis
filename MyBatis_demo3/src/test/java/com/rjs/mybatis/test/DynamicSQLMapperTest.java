...
public class DynamicSQLMapperTest {
    ...
    * 2、where:
    *   当where标签中有内容时，会自动生成where关键字，并且将内容前多余的and 或 or 去掉
    ...
    * 6、sql标签
    * 设置sql片段<select id="getEmpByCondition" resultType="Emp">
    ...
    * */
    ...
    public void testGetEmpByCondition(){
        ...
        // List<Emp> list = mapper.getEmpByChoose(new Emp(null, null, 28, "男", "123@qq.com"));
